...
OAOAOAGitHub repository: alx-react
OAOAOADirectory: 0x06-React_Immutable
OAOAOAFile: 3-list.js
4. Chained mutations
mandatory
OAOAOACreate & export a constant named map. It should create an Immutable Map with the following object:
OAOAOA
 {
OAOAOA     1: 'Liam',
     2: 'Noah',
